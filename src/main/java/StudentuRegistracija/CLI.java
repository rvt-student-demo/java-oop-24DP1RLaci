        ...
        while (program_status) { 
            ...
            switch (this.user_input = scanner.nextLine().toLowerCase().trim()) {
                ...
                case "show":
                    ...
                    break;
                case "edit":
                    System.out.println("Ievadiet lietotāja personas kodu: ");
